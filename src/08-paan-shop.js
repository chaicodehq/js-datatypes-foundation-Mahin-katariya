...
//  *        => {type:"meetha", price:50, extra:"gulkand"}
  ...
  let newBasePaan = {...basePaan};
  if(typeof customizations != "object" || customizations == null) return newBasePaan;
  return Object.assign({},basePaan,customizations);
}
// let basePaan = { "price": 30, "type": 'meetha' }
// let result = createPaanOrder(basePaan,"invalid");
// console.log(result);
...
//  *      - Agar menu object nahi hai ya increase number nahi hai, return {}
//  *      - Example: updatePrices({meetha:30, saada:20}, 10) => {meetha:40, saada:30}
  if(typeof menu != "object" || typeof increase != "number" || menu == null) return {};
  let menuEntries = Object.entries(menu);
...
//  *                 => {meetha:40, chocolate:60}
    ...
    let newCombinedObj = {...regularMenu, ...specialsMenu};
